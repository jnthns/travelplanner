...
const sakura: ThemePreset = {
  ...
  preview: { primary: '#5a7a52', secondary: '#8fad85', accent: '#5a7a52', bg: '#f5f7f2' },
  tokens: {
    bgColor: '#f5f7f2',
    surfaceColor: '#f0f5ed',
    textPrimary: '#2d3a2a',
    textSecondary: '#4a6244',
    textTertiary: '#7a9874',
    primaryColor: '#5a7a52',
    primaryHover: '#3f5e38',
    secondaryColor: '#8fad85',
    secondaryHover: '#7a9a7e',
    accentColor: '#5a7a52',
    accentHover: '#3f5e38',
    errorColor: '#ef4444',
    errorBg: 'rgba(239,68,68,0.10)',
    borderColor: 'rgba(90,122,82,0.12)',
    borderLight: 'rgba(90,122,82,0.06)',
    glassBg: 'rgba(250,248,243,0.85)',
    glassBorder: 'rgba(90,122,82,0.10)',
    shadowSm: '0 1px 2px 0 rgb(90 122 82 / 0.06)',
    shadowMd: '0 4px 12px -2px rgb(90 122 82 / 0.10), 0 2px 4px -1px rgb(45 58 42 / 0.05)',
    shadowLg: '0 16px 32px -6px rgb(90 122 82 / 0.12), 0 6px 12px -3px rgb(45 58 42 / 0.07)',
    radiusSm: '0.375rem',
    radiusMd: '0.5rem',
    radiusLg: '1rem',
    radiusXl: '1.5rem',
    ...
    fontUrl: 'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400;1,600&family=DM+Sans:wght@300;400;500;600;700&display=swap',
  },
};
